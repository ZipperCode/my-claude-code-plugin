---
description: "Switch behavioral context: dev/review/research/debug — changes tool priorities and response style"
argument-hint: "<dev|review|research|debug> [--auto]"
allowed-tools:
  - Read
  - Write
---
...
- "contexts" — Context mode definitions and auto-detection mapping
...
2. Use the auto-detection mapping table from the "contexts" skill:
...
Reference the "contexts" skill to load the full mode definition:
- Philosophy
- Tool priority order
