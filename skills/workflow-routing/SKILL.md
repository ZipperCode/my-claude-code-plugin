...
description: "This skill should be used when determining which development workflow to use (spec-kit vs openspec), when analyzing project maturity, or when routing user requests to the appropriate development flow."
---
