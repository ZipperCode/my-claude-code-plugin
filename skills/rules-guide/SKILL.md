---
name: rules-guide
description: "This skill provides guidance on detecting project language and recommending appropriate rule files from the rules/ directory. Reference this when running /maestro:init to help users set up language-specific coding rules."
---
