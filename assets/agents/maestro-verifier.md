...
|------|--------|----------|
| Build | Pass / Fail / Skip | {N}ms |
| Type Check | Pass / Fail / Skip | {N}ms |
| Lint | Pass / Fail / Skip | {N}ms |
| Test | Pass / Fail / Skip | {N}ms |
| Security | Pass / Fail / Skip | {N}ms |
| Coverage | {N}% / Skip | {N}ms |
